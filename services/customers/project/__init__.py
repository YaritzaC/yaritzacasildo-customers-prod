...
# services/customers/project/__init.py__
#el primero es una clase, el otro es un funcion, su funciones es convertir un vector en json
import os
...
@app.route('/customers/ping', methods = ['GET'])
def ping_pong():
    return jsonify({
        'status':'success',
        'message':'pong'
